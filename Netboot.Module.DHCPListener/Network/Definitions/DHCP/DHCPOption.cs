	...
	public class DHCPOption<T>
	{
		...
		public ushort AsUInt16(EndianessBehavier endianess = EndianessBehavier.LittleEndian, int offset = 0)
		{
			...
			switch (endianess)
			{
				...
				default:
					return BinaryPrimitives.ReadUInt16LittleEndian(result);
			}
		}
		...
		public uint AsUInt32(EndianessBehavier endianess = EndianessBehavier.LittleEndian, int offset = 0)
		{
			...
			{
				case EndianessBehavier.BigEndian:
					return BinaryPrimitives.ReadUInt32LittleEndian(result);
				case EndianessBehavier.LittleEndian:
				default:
					return BinaryPrimitives.ReadUInt32BigEndian(result);
			}
		}
